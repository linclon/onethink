    ...
    <div class="main">
        ...
        <nav class="navbar navbar-default navbar-fixed-bottom">
            <div class="container-fluid text-center">
                ...
                <div class="col-xs-3">
                    <p class="navbar-text"><a href="<?php echo U('Wechat/mine');?>" class="navbar-link">我的</a></p>
                </div>
            </div>
        </nav>
        <!--导航结束-->
        ...
        <div class="container-fluid">
            ...
            <div class="serviceList text-center">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-4">
                            <a href="<?php echo U('Wechat/inform');?>">
                        ...
                        <div class="col-xs-4">
                            <a href="<?php echo U('Home/Fix/add');?>">
                        ...
                        <div class="col-xs-4">
                            <a href="<?php echo U('Home/Wechat/active');?>">
                        ...
                        <div class="col-xs-4">
                            <a href="<?php echo U('Home/Wechat/sale');?>">
                        ...
                        <div class="col-xs-4">
                            <a href="<?php echo U('Home/Wechat/zone');?>">
